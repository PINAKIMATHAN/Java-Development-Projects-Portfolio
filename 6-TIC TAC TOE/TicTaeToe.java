...
public class TicTaeToe implements ActionListener{
 ...
 Image icon = Toolkit.getDefaultToolkit().getImage("C:\\Pinaki\\tic\\logo.jpeg");    
 ...
 btn1.setBackground(new Color(102,255,102));
 btn2.setBackground(new Color(102,255,102));
 btn3.setBackground(new Color(102,255,102));
 btn4.setBackground(new Color(102,255,102));
 btn5.setBackground(new Color(102,255,102));
 btn6.setBackground(new Color(102,255,102));
 btn7.setBackground(new Color(102,255,102));
 btn8.setBackground(new Color(102,255,102));
 btn9.setBackground(new Color(102,255,102));
 btn10.setBackground(new Color(102,255,102));
 ...
 btn1.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn2.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn3.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn4.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn5.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn6.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn7.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn8.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
 btn9.setBorder(BorderFactory.createLineBorder(Color.decode("#012945")));
